...
"""Config for a small conditional SAVi model (SAVi-S).

SAVi-S operates on 64x64 video frames and uses a small CNN backbone. This model
is comparable to the SAVi model evaluated on MOVi in the SAVi ICLR paper:
